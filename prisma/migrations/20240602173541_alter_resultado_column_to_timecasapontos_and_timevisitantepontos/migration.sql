/*
  ...
  - You are about to drop the column `resultado` on the `Resultados` table. All the data in the column will be lost.
...
CREATE TABLE "new_Resultados" (
    ...
    "timeVencedorId" TEXT,
    "timeCasaPontos" INTEGER NOT NULL DEFAULT 0,
    "timeVisitantePontos" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_Resultados" ("createdAt", "id", "rachaoId", "timeCasaId", "timeVencedorId", "timeVisitanteId", "updatedAt") SELECT "createdAt", "id", "rachaoId", "timeCasaId", "timeVencedorId", "timeVisitanteId", "updatedAt" FROM "Resultados";
